  ...
  return (
    <ContainerCheckout>
      ...
      <PaymentSide>
        ...
        <Explanation>
          Está compra irá entrar dentro do faturamento mensal junto com todas as
          outras despesas provenientes dos serviços da área de medicina e
          segurança do trabalho realizados pela empresa <b>Realiza</b> neste
          ultimo més.
        </Explanation>
        <FormLabel
          control={
